...
const Chefs = () => {
  return (
    <div className='lg:w-[40vw] h-[60vh] lg:h-[40vh] flex flex-col lg:flex-row md:flex-row rounded-[8px] overflow-hidden chef-shadow mb-[300px]'>
      ...
      <div className='w-[100%] md:w-[60%] lg:w-[60%] h-[60%] md:h-[100%] lg:h-[100%] bg-[#D4A373] p-[1rem] flex flex-col justify-between '>
        <div>
          <div className='flex justify-center'>
            <img className='h-[100px] md:h-[150px] lg:h-[150px]' src="https://i.ibb.co/hgkv2R6/hot-food.png" alt="" />
          </div>
          <div className='text-center'>
            <h1 className='text-2xl md:text-[4xl] lg:text-[4xl]'>Chef's name</h1>
            <div className='flex justify-evenly'>
              <div>
                <p className=' text-xl md:text-[2xl] lg:text-[2xl]'>Recipes:</p>
                <p className='text-xl md:text-[2xl] lg:text-[2xl]'>Experience:</p>
              </div>
